...
#[derive(Debug)]
pub struct BaseLayerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BaseLayerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BaseLayer processing");
    
    let mut processor = BaseLayerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BaseLayerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BaseLayerProcessor::new(false);
